  ...
  return (
    ...
    >
      <div className="w-full h-full relative flex justify-center items-center group-hover:blur-lg transition-all duration-300">
        <img src={content.images[0]} className="absolute top-0 left-0 object-cover w-full h-full" />
      </div>
      <p className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 absolute text-gray-500 text-center text-6xl font-extralight z-50">{content.place_name}</p>
    </Link>
  )
}
