  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <input className="mt-0 block w-full px-0.5 border-0 border-b-2 border-gray-200 bg-[#F6F6FC] focus:ring-0 focus:border-[#797979]" type="text" onChange={(e) => setNameInput(e.target.value)} required />
      </div>
      <div>
      ...
      <button className="bg-gray-200 p-3 rounded-lg text-white hover:bg-[#797979]">Register</button>
    </form>
    </div>
  )
}
